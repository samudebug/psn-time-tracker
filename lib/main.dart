  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MultiRepositoryProvider(providers: [
        ...
        BlocProvider(create: (context) => TrophyGroupsBloc(trophiesRepository: context.read<TrophiesRepository>())),
        BlocProvider(create: (context) => TrophiesBloc(trophiesRepository: context.read<TrophiesRepository>()))
      ],child: GamesPage()),),
    );
  }
}